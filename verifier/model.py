...
import sys
sys.path.append("/root/siton-data-Hzhang/FY/2024Exp/EBT_RL")
...
class EntailmentClassifier(pl.LightningModule):
    def __init__(
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            '/root/siton-data-Hzhang/pretrained-model/English/roberta-large', model_max_length=max_input_len
        )
        self.encoder = AutoModel.from_pretrained('/root/siton-data-Hzhang/pretrained-model/English/roberta-large')
